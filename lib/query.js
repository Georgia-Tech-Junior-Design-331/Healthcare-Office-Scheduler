...
function getPatientAccts(con, callback) { //Test query for managing accounts
    var sql = "SELECT fname, lname, username FROM db.Patients;";
...
function addRequest(con, request, appointment, callback) {
    var sql = "INSERT INTO db.Requests (a_id, urgent, type, description) VALUES ?;";
    var values = [[appointment.id, request.urgent, request.type, request.description]];
